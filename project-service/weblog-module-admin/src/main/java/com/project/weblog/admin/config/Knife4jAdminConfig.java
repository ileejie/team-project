package com.project.weblog.admin.config;
...
public class Knife4jAdminConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.project.weblog.admin.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://www.111111.com/") // API 服务条款
                .version("1.0") // 版本号
                .build();
    }
}
